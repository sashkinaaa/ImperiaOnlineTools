...
// @version    0.1
// @description  market bot for IO v5
...
//info.textContent = 'Wood max price '+woodMaxPrice+'  '+'Iron max price '+ironMaxPrice+'  '+'Stone max price '+stoneMaxPrice;
...
xajax_tradeTabs(containersStuff.findContaner({saveName:'trade',title:'?????'}),2,1);
