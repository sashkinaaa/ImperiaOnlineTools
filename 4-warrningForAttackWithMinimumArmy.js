// ==UserScript==
// @name       warrningForAttackWithMinimumArmy
// @namespace  sashkinaaa
// @version    0.1
// @description  warrning if there is attack with at minimum army
...
//prompt("Проверка за атана на през период (секунди):");
...
setInterval(checkRedFlag, 1000*intervalChecked);
